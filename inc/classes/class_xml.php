...
class xml
{
   ...
   */
    public function getFirstTagContent($tag, $input, $save = 0)
    {
   ...
   */
    public function getTagContentArray($tag, $input, $save = 0)
    {
...
#			$block[0] = str_replace("--gt--", ">", $block[0]);
    ...
    public function get_tag_content($tag_to_grab, $input, $replace_html = 1)
    {
        // Grab header
        $tag_content = preg_split("/\<$tag_to_grab\>/i", $input, 0);
        if (strpos($tag_to_grab, " ") > 0) {
