...
$lang['install']['db_subcaption']	= '<br><b>Ihre Datenbank-Struktur wurde soeben automatisch auf den neusten Stand gebracht</b>. Zusätzlich können Sie unterhalb einzellne Modul-Datenbanken zurücksetzen';
...
$lang['install']['db_rewrite_all_quest']	= 'Sind Sie sicher, dass Sie alle Tabellen zurücksetzen möchten? Damit gehen alle Datenbankeinträge unwiederruflich verloren und LanSuite wird komplett auf den Ausgangszustand zurückgesetzt.' . HTML_NEWLINE . 'ACHTUNG: Diese Aktion löscht alle Tabellen der Datenbank \'%NAME%\'; auch diejenigen, die nicht von Lansuite erstellt wurden!';
...
$lang['install']['wizard_loadwarning']	= 'Achtung: Der Aufruf der nächsten Seite kann bis zu einer Minute in Anspruch nehmen. Bitte in in dieser Zeit den Ladevorgang nicht abbrechen!';
...
$lang['install']['wizard_import_subcaption']	= 'Hier können Sie die XML- oder CSV-Datei mit den Benutzerdaten ihrer Gäste importieren. Diese erhalten Sie z.B. bei LanSurfer, oder über den Export-Link einer anderen Lansuite-Version, oder von jedem anderen System, das das Lansuite XML-Benutzerformat unterstützt.' . HTML_NEWLINE . 'Sie können den Import auch überspringen. In diesem Fall sollten Sie im nächsten Schritt einen Adminaccount anlegen.';
...
$lang['install']['wizard_admin_subcaption']	= 'Hier können Sie einen Adminaccount anlegen. Falls dies bereits durch den Import geschehen ist, können Sie diesen Schritt auch überspringen.';
...
$lang['install']['wizard_final_text']	= 'Die Installation ist nun beendet.' . HTML_NEWLINE . HTML_NEWLINE .'Mit einem Klick auf \'Schließen\' gelangen Sie auf die Adminseite. Dort können Sie weitere Konfigurationen vornehmen, sowie bereits in der Installation getätigte ändern.' . HTML_NEWLINE . HTML_NEWLINE . 'Der Modulmanager ermöglicht es Ihnen dort Module zu aktivieren, bzw. Aktivierte abschalten.' . HTML_NEWLINE . HTML_NEWLINE . 'Über den Link \'Einstellungen\' stehen Ihnen eine Vielzahl an Konfigurationen in den einzelnen Module zur Verfügung.';
...
$lang['install']['import_settings_new'] = 'Angaben für LanSuite-Export nach dem 06.02.2005';
$lang['install']['import_settings_old'] = 'Angaben für LanSurfer-Export und LanSuite-Export vor dem 06.02.2005';
$lang['install']['import_settings_lansurfer'] = 'Angaben für LanSurfer-Export';
