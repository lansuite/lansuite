    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/lansuite/lansuite/tree/master/website/',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/lansuite/lansuite',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} LANSuite team and contributors.`,
      },
      prism: {
