        ...
        switch ($seat['status']) {
            ...
            case 3:
                if (!$_GET['quest']) {
                    ...
                    array_push($questionarray, t('Sitzplatz für %1 reservieren<br>(Ein evtl. zuvor für diesen Benutzer reservierter Platz wird freigegeben)', $new_user['username']));
                    ...
                    $func->multiquestion($questionarray, $linkarray, t('Dieser Sitzplatz ist noch frei (bzw. nur markiert).<br>Soll er fest reserviert oder nur markiert werden?'));
                }
                break;
            ...
            case 2:
                if (!$_GET['quest']) {
                    ...
                    if ($seat['userid'] == $_GET['userid']) {
                        ...
                        array_push($questionarray, t('Dennoch reservieren. <br>%1 hat dadurch anschließend keinen Sitzplatz mehr', $seat['username']));
                        ...
                        array_push($questionarray, t('Dennoch reservieren und %1 anschließend einen neuen Sitzplatz aussuchen', $seat['username']));
