...
if ($module["active"] && $pdf['template_id']){
	...
	$dsp->AddSingleRow("<a class=\"menu\" href=\"index.php?mod=pdf&action=guestcards&design=base&act=print&id={$pdf['template_id']}&userid={$auth['userid']}\">{$lang["usrmgr"]["myticket_show"]}</a>");
