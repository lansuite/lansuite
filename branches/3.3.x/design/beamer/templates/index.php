...
} else $dsp->SetVar('Logo', '<a href="index.php?'. $URLQuery .'&amp;fullscreen=no" class="menu" onmouseover="return overlib(\''. t('Vollbildmodus schließen') .'\');" onmouseout="return nd();"><img src="design/'. $auth['design'] .'/images/arrows_delete.gif" border="0" alt="" /></a> - Vollbildmodus beenden');
