...
#$cfg['seating_not_paid_mark']
	...
	case 12:
		...
		elseif ($marked_seats['anz'] >= $cfg['seating_max_marks']) $func->error($lang['seating']['e_max_marked'], "index.php?mod=seating&action=show&step=2&blockid={$_GET['blockid']}");
