...
function TX_showToolTip(e, data_array) {
	if (data_array != 'null') {
		...
		for (var i = 3; i < data_array.length; i = i + 3) text += '<tr><td style="font-weight: bold;">Besucher:</td><td style="white-space:nowrap;">'+ data_array[i] +' ('+ data_array[i+1] +' '+ data_array[i+2] +')</td></tr>';
		text += '</table>';
