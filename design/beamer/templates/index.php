...
} else $dsp->SetVar('Logo', '<a href="index.php?'. $framework->get_clean_url_query('query') .'&amp;fullscreen=no" class="menu"><img src="design/'. $auth['design'] .'/images/arrows_delete.gif" border="0" alt="" /><span class="infobox">'. t('Vollbildmodus schließen') .'</span></a> - Vollbildmodus beenden');
