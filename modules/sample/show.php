...
$ms2->AddTextSearchField(t('Titel'), ['n.caption' => 'like']);
$ms2->AddTextSearchField(t('Text'), ['n.text' => 'fulltext']);
$ms2->AddTextSearchField(t('Autor'), ['u.username' => '1337', 'u.name' => 'like', 'u.firstname' => 'like']);
