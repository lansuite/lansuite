...
$helplet['value'][4] = 'LanSuite kann mit den 3 üblichen Webgrafik-Formaten umgehen: Jpeg, Png und Gif. Bei Gif-Bildern ist jedoch zu beachten, dass bei Älteren PHP-Versionen hier keine Thumbnails generiert werden können. Um zu sehen, ob dies bei dir funktioniert, wirf einen Blick auf die Version und Komponenten Ihrer GD-Bibliothek (Zu sehen auf der Admin-Seite bei den Systemvorraussetzungen).';
