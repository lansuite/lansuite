  ...
  function text2html($string, $mode = 0) { // mode 0: default; 1: wiki before; 2: wiki after; 4: basic
      ...
      if ($mode != 4) {
        ...
        if ($mode != 2) {
          ...
          $string = preg_replace('#\\[url=http(s)?://([^\\]]*)\\]([^[]*)\\[/url\\]#sUi', '<a target="_blank" href="\\1" rel="nofollow">\\2</a>', $string);

          if ($mode != 1) {
            $string = preg_replace('#(\\s|^)(http(s)?://(.)*)(\\s|$)#sUi', '\\1<a target="_blank" href="\\2" rel="nofollow">\\2</a>\\4', $string);
          }
        }
      }
