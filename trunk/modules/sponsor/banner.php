...
if (substr($file_name, 0, 12) == 'html-code://') $templ['index']['banner_code'] = substr($file_name, 12, strlen($file_name) - 12);
	...
	if ($cfg['sys_internet']) $templ['index']['banner_code'] = '<a href="index.php?mod=sponsor&action=bannerclick&design=base&type=banner&sponsorid='. $banner["sponsorid"] .'" target="_blank">'. $templ['index']['banner_code'] .'</a>';
}
?>
