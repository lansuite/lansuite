		...
		if ($row_new_msg['senderid']){
			...
			if($cfg['msgsys_popup']){
				$caption = "<script type=\"text/javascript\" language=\"JavaScript\"> 
								var link = \"index.php?mod=msgsys&amp;action=query&amp;design=popup&amp;queryid={$row["buddyid"]}$msg_sid\";
								var suche = /&amp;/;
