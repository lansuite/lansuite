...
class party
{
    ...
    public function GetPriceDropdown($group_id = 0, $price_id = 0)
    {
        ...
        $mf->AddField(t('Preis auswählen'), 'price_id', \LanSuite\MasterForm::IS_SELECTION, $selections);
    ...
    public function GetUserGroupDropdown($group_id = "NULL", $nogroub = 0, $select_id = 0, $javascript = false)
    {
        ...
        $mf->AddField(t('Benutzergruppe'), 'group_id', \LanSuite\MasterForm::IS_SELECTION, $selections);
        return true;
    }
