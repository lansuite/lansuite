...
$lang['install']['db_rewrite_this_module_quest']	= 'Sind Sie sicher, dass Sie die Datenbank dieses Moduls zurücksetzen möchten? Alle Einträge in dem Modul gehen dadurch unwiderruflich verloren!.';
...
$lang['install']['mod_reset_quest']	= 'Sollen wirklich alle Module zurückgesetzt werden?' . HTML_NEWLINE . 'Dies wirkt sich nicht auf die Datenbankeinträge der Modules aus, jedoch gehen alle Einstellungen und Menüänderungen verloren, die zu den Modulen getätigt worden sind. Außerdem sind danach nur noch die Standardmodule aktiviert.';
$lang['install']['mod_reset_mod_quest']	= 'Soll das Modul \'%NAME%\' wirklich zurückgesetzt werden?' . HTML_NEWLINE . 'Dies wirkt sich nicht auf die Datenbankeinträge des Modules aus, jedoch gehen alle Einstellungen und Menüänderungen verloren, die zu den Modulen getätigt worden sind. Außerdem sind danach nur noch die Standardmodule aktiviert.';
...
$lang['install']['env_ext_inc']	= 'In den Ordner <b>ext_inc</b> und alle seine Unterordner muss geschrieben werden k&ouml;nnen. &Auml;ndern Sie bitte die Zugriffsrechte entsprechend. Dies k&ouml;nnen Sie mit den meisten guten FTP-Clients erledigen. Die Datei muss mindestens die Schreibrechte (chmod) 666 besitzen.';
