    ...
    public function lgz_export($eventid)
    {
        ...
        while ($tournament = $db->fetch_array($tournaments)) {
            ...
            while ($db_team = $db->fetch_array($db_teams)) {
                $lgz_id = $db_team['lgzid'];
                if ($lgz_id == "") {
                    $lgz_id = 0;
                }
                $lgz_clanid = $db_team['lgzclanid'];
                if ($lgz_clanid == "") {
                    $lgz_clanid = 0;
                }
