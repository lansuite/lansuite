...
$dsp->NewContent("Designinfo zu '<b>$design_name</b>'", "Auf dieser Seite erhalten Sie Informationen &uuml;ber das derzeitige Lansuite-Erscheinungsbild");
...
$dsp->AddDoubleRow("Kommentar", $xml->get_tag_content("comment",$xml_content));
