...
switch($_GET["step"]){
    ...
    if ($auth['type'] >= 3) $ms2->AddMultiSelectAction(t('Session beenden'), "index.php?mod=misc&action=sessions&step=10", 1);

    $ms2->PrintSearch('index.php?mod=misc&action=sessions', 'a.sessid');
	break;
